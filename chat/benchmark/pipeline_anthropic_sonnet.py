"""Benchmark do pipeline completo para o Claude Sonnet 4.6.

Igual ao `pipeline_ollama.py`, mas força o pipeline a rodar com o modelo
Anthropic Sonnet. Rodamos Sonnet e Haiku em scripts separados de propósito,
...
Uso:
    cd chat
    python benchmark/pipeline_anthropic_sonnet.py
"""
import csv
import json
import time
...
def main() -> None:
    ...
    output = Path(__file__).parent / "results_pl_anthropic_sonnet.csv"
